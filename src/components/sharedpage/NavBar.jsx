                ...
                <div className='max-w-9xl mx-auto '>
                    <div className='flex items-center justify-around  h-16'>
                        ...
                        <div className=' md:hidden flex flex-col items-end relative'>
                            ...
                            <a href="#">Contact</a>
                            <a href="/sideLayout"
                            className='border-1 rounded-full p-1 border-gray-400 text-xs '>Seller Dashboard</a>
                                          <div>
                                <div className="flex items-center space-x-2">
                                    <input
                                        type="text"
                                        ...
                                        onChange={(e) => setQuery(e.target.value)}
                                        placeholder="Search"
                                        className={`transition-all w-[80px] duration-300 border border-gray-300 rounded-full px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400
                                          ${isOpen ? "w-64 opacity-100" : "w-0 opacity-0 px-0"} `}
                                    />
                                    <button
                                        onClick={handleSearch}
                                ...
                                <div>
                                <button className="btn relative flex items-center gap- overflow-hidden px-3 py-1 border-2 rounded-full border-amber-600  cursor-pointer">Login</button>
                            </div>
                            </div>
                                    </div>

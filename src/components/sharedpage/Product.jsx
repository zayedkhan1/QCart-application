    ...
    <div>
      ...
      <div className="p-4 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="flex gap-2 mt-4 justify-center flex-wrap">
            {product.images.map((img, index) => (
              <img
                ...
                className={`w-20 h-20 object-cover border rounded-lg cursor-pointer transition duration-200 hover:scale-105 ${mainImage === img ? "border-orange-500" : "border-gray-300"
                  }`}
              />
            ))}
          </div>
        ...
        <div className="flex flex-col justify-center ">
          ...
          <div className=" h-20 flex items-center gap-3 border-b-1 border-gray-300">
            <span className="text-2xl text-gray-600 md:text-3xl font-bold">${product.price}</span>
            <span className="text-gray-400 line-through">${product.oldPrice}</span>
          </div>
          <div className="mt-6 mb-4 text-gray-700 text-sm space-y-2   ">
